...
-- sub quary or nested quary
select * from film;
select film_id, rental_duration from film where  film_id=1; -- iska out put nikal ne ke badh hi next output nikal payenge...so is called sub quary.
select film_id, rental_duration from film where rental_duration=6; 
select film_id, rental_duration from film where  film_id=(select rental_duration from film where rental_duration=6 ); 
